...
public final class StageClient extends AbstractStageClient {
    ...
    @Override protected String getStageOutputPath() {
        return "target/hadoopwork/${execution_id}/csBatch/CleansingSampleJobFlow/stage0002";
    }
    @Override protected List<StageInput> getStageInputs() {
        ...
        results.add(new StageInput(
                "target/hadoopwork/${execution_id}/csBatch/CleansingSampleJobFlow/stage0001/result10-*", 
                TemporaryInputFormat.class, StageMapper1.class, attributes));
        attributes = new HashMap<String, String>();
        results.add(new StageInput(
                "target/hadoopwork/${execution_id}/csBatch/CleansingSampleJobFlow/stage0001/result0-*", 
    ...
    @Override protected List<StageOutput> getStageOutputs() {
        ...
        results.add(new StageOutput("result0", NullWritable.class, OriginalData.class, TemporaryOutputFormat.class));
        return results;
    }
