...
/**
 * {@code [in->padding(pseud#1884473012){owner=FlowBlock&#64;284230355}]}の処理を担当するマッププログラム。
 */
@SuppressWarnings("deprecation") public final class StageMapper1 extends Mapper<NullWritable, OriginalDataA, ShuffleKey, 
        ShuffleValue> {
    private OriginalDataA cache = new OriginalDataA();
