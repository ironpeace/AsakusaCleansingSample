...
public final class StageClient extends AbstractStageClient {
    ...
    @Override protected String getStageOutputPath() {
        return "target/hadoopwork/${execution_id}/csBatch/CleansingSampleJobFlow/epilogue/directio";
    }
    @Override protected List<StageInput> getStageInputs() {
        ...
        results.add(new StageInput(
                "target/hadoopwork/${execution_id}/csBatch/CleansingSampleJobFlow/stage0002/result0-*", 
    ...
    @Override protected List<StageOutput> getStageOutputs() {
        ...
        Map<String, String> attributes = null;
        attributes = new HashMap<String, String>();
        results.add(new StageOutput("ironpeace/cs/output/", NullWritable.class, OriginalData.class, BridgeOutputFormat.
                class, attributes));
        return results;
    }
