...
/**
 * CSV format for {@link OriginalDataA}.
 */
public final class OriginalDataACsvFormat extends BinaryStreamFormat<OriginalDataA> {
    /**
    ...
    @Override public Class<OriginalDataA> getSupportedType() {
    ...
    @Override public ModelInput<OriginalDataA> createInput(Class<? extends OriginalDataA> dataType, String path, 
    ...
    @Override public ModelOutput<OriginalDataA> createOutput(Class<? extends OriginalDataA> dataType, String path, 
    ...
    private static final class Reader implements ModelInput<OriginalDataA> {
        private final CsvParser parser;
        Reader(CsvParser parser) {
            this.parser = parser;
        }
        @Override public boolean readTo(OriginalDataA object) throws IOException {
    ...
    private static final class Writer implements ModelOutput<OriginalDataA> {
        private final CsvEmitter emitter;
        Writer(CsvEmitter emitter) {
            this.emitter = emitter;
        }
        @Override public void write(OriginalDataA object) throws IOException {
