...
import ironpeace.modelgen.dmdl.io.JoineddataInput;
import ironpeace.modelgen.dmdl.io.JoineddataOutput;
...
/**
 * joineddataを表すデータモデルクラス。
 */
@DataModelKind("DMDL")@Joined(terms = {@Joined.Term(source = DataA.class, mappings = {@Joined.Mapping(source = "userid", 
                destination = "userid"),@Joined.Mapping(source = "dataA0", destination = "dataA0"),@Joined.Mapping(
                source = "dataA1", destination = "dataA1")}, shuffle = @Key(group = {"userid"})),@Joined.Term(source = 
            DataB.class, mappings = {@Joined.Mapping(source = "userid", destination = "userid"),@Joined.Mapping(source = 
                "dataB0", destination = "dataB0"),@Joined.Mapping(source = "dataB1", destination = "dataB1")}, shuffle = 
            @Key(group = {"userid"}))})@ModelInputLocation(JoineddataInput.class)@ModelOutputLocation(JoineddataOutput.
        class)@PropertyOrder({"userid", "data_a_0", "data_a_1", "data_b_0", "data_b_1"}) public class Joineddata 
        implements DataModel<Joineddata>, Writable {
    ...
    @Override@SuppressWarnings("deprecation") public void copyFrom(Joineddata other) {
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=joineddata");
    ...
    @Override public boolean equals(Object obj) {
        ...
        Joineddata other = (Joineddata) obj;
